...
public class DatabaseSeeder {
    ...
    private TeamEntity createRealMadridSenior() {
        ...
        team.addPlayer(createPlayer("Andriy", "Lunin", 13, "GK", "Ukraine", "1999-02-11", "https://b.fssta.com/uploads/application/soccer/headshots/53635.png"));
        team.addPlayer(createPlayer("Fran", "González", 25, "GK", "Spain", "2005-06-24", "https://b.fssta.com/uploads/application/soccer/headshots/101037.png"));
        ...
        team.addPlayer(createPlayer("Antonio", "Rüdiger", 22, "CB", "Germany", "1993-03-03", "https://b.fssta.com/uploads/application/soccer/headshots/2330.png"));
        team.addPlayer(createPlayer("Ferland", "Mendy", 23, "LB", "France", "1995-06-08", "https://b.fssta.com/uploads/application/soccer/headshots/54266.png"));
        team.addPlayer(createPlayer("Lucas", "Vázquez", 17, "RB", "Spain", "1991-07-01", "https://b.fssta.com/uploads/application/soccer/headshots/2030.png"));
        team.addPlayer(createPlayer("Fran", "García", 20, "LB", "Spain", "1999-08-14", "https://b.fssta.com/uploads/application/soccer/headshots/60109.png"));
        team.addPlayer(createPlayer("Jesús", "Vallejo", 18, "CB", "Spain", "1997-01-05", "https://b.fssta.com/uploads/application/soccer/headshots/2021.png"));
        ...
        team.addPlayer(createPlayer("Eduardo", "Camavinga", 6, "CM", "France", "2002-11-10", "https://b.fssta.com/uploads/application/soccer/headshots/69367.png"));
        team.addPlayer(createPlayer("Federico", "Valverde", 8, "CM", "Uruguay", "1998-07-22", "https://b.fssta.com/uploads/application/soccer/headshots/42653.png"));
        team.addPlayer(createPlayer("Luka", "Modric", 10, "CM", "Croatia", "1985-09-09", "https://b.fssta.com/uploads/application/soccer/headshots/880.png"));
        team.addPlayer(createPlayer("Aurélien", "Tchouaméni", 14, "CDM", "France", "2000-01-27", "https://b.fssta.com/uploads/application/soccer/headshots/58145.png"));
        team.addPlayer(createPlayer("Arda", "Güler", 15, "AM", "Turkey", "2005-02-25", "https://b.fssta.com/uploads/application/soccer/headshots/90609.png"));
        team.addPlayer(createPlayer("Dani", "Ceballos", 19, "CM", "Spain", "1996-08-07", "https://b.fssta.com/uploads/application/soccer/headshots/31338.png"));

        // Attaquants
        team.addPlayer(createPlayer("Vinícius", "Júnior", 7, "LW", "Brazil", "2000-07-12", "https://b.fssta.com/uploads/application/soccer/headshots/53004.png"));
        team.addPlayer(createPlayer("Kylian", "Mbappé", 9, "ST", "France", "1998-12-20", "https://b.fssta.com/uploads/application/soccer/headshots/40670.png"));
        team.addPlayer(createPlayer("Rodrygo", "Goes", 11, "RW", "Brazil", "2001-01-09", "https://b.fssta.com/uploads/application/soccer/headshots/67951.png"));
        ...
        team.addPlayer(createPlayer("Brahim", "Díaz", 21, "RW", "Morocco", "1999-08-03", "https://b.fssta.com/uploads/application/soccer/headshots/41810.png"));
    ...
    private TeamEntity createPSGSenior() {
        ...
        // Gardiens
        team.addPlayer(createPlayer("Gianluigi", "Donnarumma", 1, "GK", "Italy", "1999-02-25", "https://b.fssta.com/uploads/application/soccer/headshots/31875.png"));
        ...
        team.addPlayer(createPlayer("Arnau", "Tenas", 80, "GK", "Spain", "2001-05-30", "https://b.fssta.com/uploads/application/soccer/headshots/113458.png"));

        // Défenseurs
        team.addPlayer(createPlayer("Achraf", "Hakimi", 2, "RB", "Morocco", "1998-11-04", "https://b.fssta.com/uploads/application/soccer/headshots/44920.png"));
        team.addPlayer(createPlayer("Marquinhos", "Aoás Corrêa", 5, "CB", "Brazil", "1994-05-14", "https://b.fssta.com/uploads/application/soccer/headshots/75573.png"));
        team.addPlayer(createPlayer("Lucas", "Hernández", 21, "CB", "France", "1996-02-14", "https://b.fssta.com/uploads/application/soccer/headshots/1104.png"));
        ...
        team.addPlayer(createPlayer("Lucas", "Beraldo", 35, "CB", "Brazil", "2003-11-24", "https://b.fssta.com/uploads/application/soccer/headshots/90475.png"));
        team.addPlayer(createPlayer("Nuno", "Mendes", 25, "LB", "Portugal", "2002-06-19", "https://b.fssta.com/uploads/application/soccer/headshots/74576.png"));
        team.addPlayer(createPlayer("Milan", "Škriniar", 37, "CB", "Slovakia", "1995-02-11", "https://b.fssta.com/uploads/application/soccer/headshots/42188.png"));
        team.addPlayer(createPlayer("Yoram", "Zague", 42, "RB", "France", "2006-05-15", "https://b.fssta.com/uploads/application/soccer/headshots/113459.png"));
        ...
        team.addPlayer(createPlayer("Warren", "Zaïre-Emery", 33, "CM", "France", "2006-03-08", "https://b.fssta.com/uploads/application/soccer/headshots/106915.png"));
        team.addPlayer(createPlayer("Fabián", "Ruiz", 8, "CM", "Spain", "1996-04-03", "https://b.fssta.com/uploads/application/soccer/headshots/30456.png"));
        ...
        team.addPlayer(createPlayer("Senny", "Mayulu", 24, "CAM", "France", "2006-05-17", "https://b.fssta.com/uploads/application/soccer/headshots/113460.png"));

        // Attaquants
        team.addPlayer(createPlayer("Ousmane", "Dembélé", 10, "RW", "France", "1997-05-15", "https://b.fssta.com/uploads/application/soccer/headshots/39732.png"));
        team.addPlayer(createPlayer("Bradley", "Barcola", 29, "LW", "France", "2002-09-02", "https://b.fssta.com/uploads/application/soccer/headshots/95034.png"));
        team.addPlayer(createPlayer("Marco", "Asensio", 11, "CAM", "Spain", "1996-01-21", "https://b.fssta.com/uploads/application/soccer/headshots/7199.png"));
        ...
        team.addPlayer(createPlayer("Gonçalo", "Ramos", 9, "ST", "Portugal", "2001-06-20", "https://b.fssta.com/uploads/application/soccer/headshots/74559.png"));
        team.addPlayer(createPlayer("Randal", "Kolo Muani", 23, "ST", "France", "1998-12-05", "https://b.fssta.com/uploads/application/soccer/headshots/50949.png"));
