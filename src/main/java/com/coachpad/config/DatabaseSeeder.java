...
public class DatabaseSeeder {
    ...
    private TeamEntity createRealMadridCastilla() {
        ...
        TeamDesignEntity design = TeamDesignEntity.builder().style(WidgetAppearance.CIRCLE)
                ...
                .logoFilePath(
                        "https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg.png")
                .usePlayerPhotos(true).build();
        TeamEntity team = TeamEntity.builder().name("Real Madrid Castilla").nickname("La Fábrica").ageCategory("U21")
                .design(design).build();
        colors.setDesign(design);
        design.setTeam(team);
    ...
    private TeamEntity createRealMadridJuvenilA() {
        ...
        TeamEntity team = TeamEntity.builder().name("Real Madrid Juvenil A").nickname("Juveniles").ageCategory("U19")
                .design(design).build();
        colors.setDesign(design);
        design.setTeam(team);
    ...
    private TeamEntity createPSGSenior() {
        ...
        team.addCoach(createCoach("Luis", "Enrique", CoachRole.HEAD_COACH, LicenseLevel.UEFA_PRO,
                CoachingPhilosophy.TIKI_TAKA, "https://b.fssta.com/uploads/application/soccer/headshots/2357.png"));
    ...
    private TeamEntity createPSGU17() {
        ...
        TeamDesignEntity design = TeamDesignEntity.builder().style(WidgetAppearance.CIRCLE)
                ...
                .logoFilePath(
                        "https://upload.wikimedia.org/wikipedia/en/thumb/a/a7/Paris_Saint-Germain_F.C..svg/1200px-Paris_Saint-Germain_F.C..svg.png")
                .usePlayerPhotos(false).build();
        TeamEntity team = TeamEntity.builder().name("PSG U17").nickname("Espoirs").ageCategory("U17").design(design)
                .build();
        colors.setDesign(design);
        design.setTeam(team);
    ...
    private CoachEntity createCoach(String fn, String ln, CoachRole role, LicenseLevel level, CoachingPhilosophy phil,
            String photo) {
